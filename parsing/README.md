...
[buffer-parser](buffer) перетворює масив цілих чисел (Int16) або буфер на об’єкт значень відповідно до наданої специфікації.

[buffer-maker](buffer) перетворює масив цілих чисел (Int16) або буфер на об’єкт значень відповідно до наданої специфікації.