...
Записує дані в PLC у змінну, вказану в конфігурації вузла, або на `msg.variable`. Можна одночасно записати до кількох змінних, встановивши і `msgvariable`, і `msg.payload` для масивів, що містять імена змінних та їх значення відповідно. Зверніть увагу, що вони не можуть бути записані в один і той же цикл запису в ПЛК, залежно від кількості змінних, які слід записати.
