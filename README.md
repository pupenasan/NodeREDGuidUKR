...
За редакцією [Олександра Пупени](https://github.com/pupenasan)
...
Зміст довідника наведений нижче. Окрім довідникових матеріалів, репозиторій містить розділи:
...
## Допомога проєкту та зворотній зв'язок

Якщо хочете інтенсифікувати створення україномовного контенту Node-RED то можете задонатити на Моно-банку. 

🔗Посилання на банку
https://send.monobank.ua/jar/3JCWpSqwEC
...
| ![image-20250901111125808](media/image-20250901111125808.png) | [buffer-parser](parsing/buffer) перетворює масив цілих чисел (Int16) або буфер на об’єкт значень відповідно до наданої специфікації. | 09.2025  |
| ![image-20250901111127632](media/image-20250901111127632.png) | [buffer-maker](parsing/buffer) перетворює масив цілих чисел (Int16) або буфер на об’єкт значень відповідно до наданої специфікації. | 09.2025  |
